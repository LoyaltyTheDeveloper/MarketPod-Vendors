...
function AboutUs() {
  ...
  <div className="pt-[90px] min-h-screen bg-[#F9F9F9]">
    ...
    <div className="absolute text-[white] ml-[60px] mt-[-140px] lg:ml-[120px] lg:mt-[-250px]">
        <div className="font-bold text-[20px] lg:text-[30px] font-saeada">The Story Of Our Company</div>
    ...
    <div className="bg-[white] mt-[30px] flex flex-col gap-y-[20px] p-[30px] rounded-[10px]">
      <div className="font-bold text-2xl font-saeada">About Us</div>
      ...
      <div className="font-bold text-2xl mt-[10px] font-saeada">Our Promise</div>
    ...
    <div className="mt-[30px] flex flex-row gap-x-[20px] bg-[#31603D] rounded-[10px]">
        ...
        <div className="font-bold text-2xl text-[white] font-saeada">Company Vision</div>
