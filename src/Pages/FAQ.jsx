  ...
  <div className="min-h-screen bg-[#F9F9F9]">
    ...
    <div className="bg-[white] mt-[30px] flex flex-col gap-y-[20px] p-[30px] rounded-[10px]">
      <div className="flex flex-col justify-center gap-y-[10px]">
        <div className="font-bold flex justify-center text-2xl lg:text-3xl font-bitter">Frequently Asked Questions !</div>
        ...
        <div className="flex row gap-x-[10px]">
          ...
          <div className="text-[22px] font-bold lg:text-[22px] font-bitter">What is MarketPod ?</div>
        ...
        <div className="flex row gap-x-[10px]">
          <div><IoCaretForwardSharp className="absolute text-[#31603D] ml-[-30px] mt-[3px] size-[30px] lg:mt-[6px]"/></div>
          <div className="flex flex-col gap-y-[10px]">
          <div className="text-[22px] font-bold lg:text-[22px] font-bitter">How MarketPod Works?</div>
        ...
        <div className="flex row gap-x-[10px]">
          <div><IoCaretForwardSharp className="absolute text-[#31603D] ml-[-30px] mt-[3px] size-[30px] lg:mt-[6px]"/></div>
          <div className="flex flex-col gap-y-[10px]">
          <div className="text-[22px] font-bold lg:text-[22px] font-bitter">Is there a delivery fee ?</div>
        ...
        <div className="flex row gap-x-[10px]">
          <div><IoCaretForwardSharp className="absolute text-[#31603D] ml-[-30px] mt-[3px] size-[30px] lg:mt-[6px]"/></div>
          <div className="flex flex-col gap-y-[10px]">
          <div className="text-[22px] font-bold lg:text-[22px] font-bitter">What type of products can I order on Marketpod ?</div>
        ...
        <div className="flex row gap-x-[10px]">
          <div><IoCaretForwardSharp className="absolute text-[#31603D] ml-[-30px] mt-[3px] size-[30px] lg:mt-[6px]"/></div>
          <div className="flex flex-col gap-y-[10px]">
          <div className="text-[22px] font-bold lg:text-[22px] font-bitter">Can I cancel or modify my order ?</div>
        ...
        <div className="flex row gap-x-[10px]">
          <div><IoCaretForwardSharp className="absolute text-[#31603D] ml-[-30px] mt-[3px] size-[30px] lg:mt-[6px]"/></div>
          <div className="flex flex-col gap-y-[10px]">
          <div className="text-[22px] font-bold lg:text-[22px] font-bitter">How do I contact customer support ?</div>
        ...
        <div className="flex row gap-x-[10px]">
          <div><IoCaretForwardSharp className="absolute text-[#31603D] ml-[-30px] mt-[3px] size-[30px] lg:mt-[6px]"/></div>
          <div className="flex flex-col gap-y-[10px]">
          <div className="text-[22px] font-bold lg:text-[22px] font-bitter">Is Marketpod available in all locations ?</div>
        ...
        <div className="flex row gap-x-[10px]">
          <div><IoCaretForwardSharp className="absolute text-[#31603D] ml-[-30px] mt-[3px] size-[30px] lg:mt-[6px]"/></div>
          <div className="flex flex-col gap-y-[10px]">
          <div className="text-[22px] font-bold lg:text-[22px] font-bitter">How do I register as a vendor on MarketPod ?</div>
        ...
        <div className="flex row gap-x-[10px]">
          <div><IoCaretForwardSharp className="absolute text-[#31603D] ml-[-30px] mt-[3px] size-[30px] lg:mt-[6px]"/></div>
          <div className="flex flex-col gap-y-[10px]">
          <div className="text-[22px] font-bold lg:text-[22px] font-bitter">What is the payout plan for vendors ?</div>
