...
<div className="font-sans">Access and Use: You are responsible for obtaining the necessary resources to access our platform and ensuring that anyone using your account complies with these Terms.<br></br>
Account Security: You agree to keep your account credentials confidential and to notify us immediately if you suspect any unauthorized access or use of your account.<br></br>
Responsibility: All activities that occur under your account are your responsibility.</div>
...
<div className="font-sans">Marketpod reserves the right to restrict, suspend, or terminate your account and access to the platform at our discretion without prior notice if these Terms are violated.</div>

<div className="font-bold font-sans">10. Modification to Terms</div>
<div className="font-sans">We reserve the right to revise these Terms at any time. Updates will be posted on our website with an updated effective date. Continued use of the platform after any changes signifies your acceptance of the revised Terms.</div>

<div className="font-bold font-sans">11. Personal Data</div>
<div className="font-sans">We are committed to protecting user privacy and processing personal data responsibly. For details on data handling and protection, please refer to our Privacy Policy. We do not share user information with third parties except as required for payment processing.</div>

<div className="font-bold font-sans">12. Placing Orders</div>
<div className="font-sans">Product Representations: The product images on our platform are for illustrative purposes. While we aim for accuracy, actual items may differ slightly from stock photos.<br></br>
Order Confirmation: Orders are finalized at checkout. Before confirming, you will have an opportunity to review your selections and make any corrections. Confirmation signifies your acceptance of the order.<br></br>
Order Summary: Your account dashboard provides a summary and history of orders and payments made on the platform.</div>

<div className="font-bold font-sans">13. Delivery of Your Order</div>
<div className="font-sans">Marketpod is responsible for delivering orders to the address provided by the user. If any issues arise with order delivery, users must contact customer support promptly. If orders are undelivered, Marketpod will issue a refund where appropriate.<br></br>
User Responsibility: You are responsible for ensuring the accuracy of delivery information provided, including address and contact details. If you encounter any discrepancies or issues with an order, you must contact Marketpod immediately without tampering with the delivered items.</div>

<div className="font-bold font-sans">14. Contact Information</div>
<div className="font-sans">If you have questions or concerns regarding these Terms, please reach out to us at [support@emarketpod.com] or through the Contact Us page on our website.<br></br>
By using Marketpod, you confirm that you have read, understood, and agreed to these Terms and accept the responsibilities outlined.</div>
    </div>
    </div>
  </div>
  <Footer/>
