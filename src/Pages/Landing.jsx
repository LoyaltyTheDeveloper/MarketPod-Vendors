...
function Landing() {
  ...
  <Navbar scrollToSection={scrollToSection}/>
    ...
    <div className="pt-[90px]">
      ...
      <div className="text-[30px] text-[white] font-bold w-[250px] lg:text-[60px] lg:w-[500px] font-bitter">Increase Your<br></br>Stall Sales</div>
...
<div className="max-w-sm bg-white border border-[#31603D] rounded-lg shadow h-[420px]">
    ...
    <div className="flex flex-col justify-center items-center">
            <h5 className="mb-1 text-[22px] font-bold tracking-tight text-gray-900 text-[black] mt-[10px] font-bitter">Register as a Vendor</h5>
...
<div className="max-w-sm bg-white border border-[#31603D] rounded-lg shadow h-[420px]">
    ...
    <div className="flex flex-col justify-center items-center">
            <h5 className="mb-1 text-[22px] font-bold tracking-tight text-gray-900 text-[black] mt-[10px] font-bitter">Enjoy Your Digital Stall</h5>
      ...
      <div className="mt-[60px] mb-[30px]">
        ...
        <div className="flex flex-col gap-[20px] lg:px-[110px]">
          ...
          <div className="flex">
            ...
            <div className="font-bold text-[20px] lg:text-[20px] font-bitter">How do i register as a vendor on MarketPod ?</div>
          ...
          <div className="flex">
            <div className="absolute left-[40px] lg:left-[140px] text-[#31603D]"><IoCaretForwardSharp className="size-[30px]"/></div>
            <div className="px-[70px]">
            <div className="font-bold text-[20px] lg:text-[20px] font-bitter">What is the payout plan for vendors ?</div>
          ...
          <div className="flex">
            <div className="absolute left-[40px] lg:left-[140px] text-[#31603D]"><IoCaretForwardSharp className="size-[30px]"/></div>
            <div className="px-[70px]">
            <div className="font-bold lg:text-[20px] font-bitter text-[20px]">Are there any fees attached to registration ?</div>
